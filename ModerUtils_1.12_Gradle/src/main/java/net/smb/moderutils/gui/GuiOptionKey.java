...
public class GuiOptionKey extends GuiElement{
    ...
    public void keyTyped(char key, int keyId) {
    	if(!this.option.equals("")) ModuleSettings.setControlKey(this.option, keyId);
    	
    	this.displayString = getOptionKeyName();
    }
    
    public String getOptionKeyName() {
    	if(!this.option.equals("")) return Keyboard.getKeyName(ModuleSettings.getControlKey(this.option));
    	else return "None";
    }
}
