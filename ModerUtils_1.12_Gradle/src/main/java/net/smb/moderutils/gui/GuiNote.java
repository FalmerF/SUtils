...
public class GuiNote extends GuiElement {
    ...
    public GuiNote(int noteId, int posX, int posY, String title, String description, boolean canEdit)
    {
        ...
        this.pined = ModuleSettings.getBool("notePined" + this.noteId);
        this.background = ModuleSettings.getBool("noteBackground" + this.noteId);
        ...
        if(this.canEdit) {
	        ...
	        titleField = new GuiField(4, 13, 30, 146, "���������...", "noteTitle" + this.noteId, GuiField.FieldType.STANDART);
	        titleField.visible = false;
	        titleField.multiline = true;
	        titleField.fieldLimit = 50;
	        this.elements.add(titleField);
	        
	        descriptionField = new GuiField(5, 13, 50, 146, "��������...", "noteDesc" + this.noteId, GuiField.FieldType.STANDART);
        ...
        ModuleSettings.setParam("notePosX" + this.noteId, this.posX);
		ModuleSettings.setParam("notePosY" + this.noteId, this.posY);
		ModuleSettings.setParam("noteTitle" + this.noteId, this.title);
		ModuleSettings.setParam("noteDesc" + this.noteId, this.description);
	...
	public void draw(Minecraft mc, int positionX, int positionY)
    {
        if (this.visible)
        {
            ...
            if(this.canEdit || this.background) {
	            ...
	            this.drawScaledCustomSizeModalRect(this.posX+this.width-this.minWidth/2, this.posY, 2, 0, 1, 1, this.minWidth/2, this.minHeight/2, 3, 3);
	            this.drawScaledCustomSizeModalRect(this.posX+this.width-this.minWidth/2, this.posY+this.height-this.minHeight/2, 2, 2, 1, 1, this.minWidth/2, this.minHeight/2, 3, 3);
	            this.drawScaledCustomSizeModalRect(this.posX, this.posY+this.height-this.minHeight/2, 0, 2, 1, 1, this.minWidth/2, this.minHeight/2, 3, 3);
	            
	            this.drawScaledCustomSizeModalRect(this.posX, this.posY+this.minHeight/2, 0, 1, 1, 1, this.minWidth/2, this.height-this.minHeight, 3, 3);
	            this.drawScaledCustomSizeModalRect(this.posX+this.width-this.minWidth/2, this.posY+this.minHeight/2, 2, 1, 1, 1, this.minWidth/2, this.height-this.minHeight, 3, 3);
	            this.drawScaledCustomSizeModalRect(this.posX+this.minWidth/2, this.posY, 1, 0, 1, 1, this.width-this.minWidth, this.minHeight/2, 3, 3);
	            this.drawScaledCustomSizeModalRect(this.posX+this.minWidth/2, this.posY+this.height-this.minHeight/2, 1, 2, 1, 1, this.width-this.minWidth, this.minHeight/2, 3, 3);
	            
	            this.drawScaledCustomSizeModalRect(this.posX+this.minWidth/2, this.posY+this.minHeight/2, 1, 1, 1, 1, this.width-this.minWidth, this.height-this.minHeight, 3, 3);
            }
    	...
    	switch(element.id) {
			case 0:
				if(mc.currentScreen != null && (mc.currentScreen instanceof GuiScreenNotes)) {
					ModuleSettings.setParam("noteTitle" + this.noteId, "");
					ModuleSettings.setParam("noteDesc" + this.noteId, "");
			...
			case 2:
				...
				ModuleSettings.setParam("notePined" + this.noteId, this.pined);
				break;
			case 3:
				this.background = !this.background;
				this.SetButtonColor((GuiButtonImage) element, this.background);
				
				ModuleSettings.setParam("noteBackground" + this.noteId, this.background);
				break;
			case 4:
				if(mc.currentScreen != null && (mc.currentScreen instanceof GuiScreenNotes)) {
