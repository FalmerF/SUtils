...
public class GuiScrollView extends GuiElement {
	...
	public void draw(Minecraft mc, int posX, int posY)
    {
        if (this.visible)
        {
            ...
            this.func_152125_a(this.posX+this.width-this.barWidth, this.posY, 0, 0, 1, 1, this.barWidth, this.minHeight, 1, 3);
            this.func_152125_a(this.posX+this.width-this.barWidth, this.posY+this.height-this.minHeight, 0, 2, 1, 1, this.barWidth, this.minHeight, 1, 3);
            this.func_152125_a(this.posX+this.width-this.barWidth, this.posY+this.minHeight, 0, 1, 1, 1, this.barWidth, this.height-(this.minHeight*2), 1, 3);
            
            // Draw Scroll Handle
            mc.getTextureManager().bindTexture(GuiTheme.scrollHandle);
            this.func_152125_a(this.posX+this.width-this.barWidth, (int)(this.posY+((this.height-(this.barWidth*4))*value)), 0, 0, 1, 1, this.barWidth, this.barWidth*4, 1, 1);
