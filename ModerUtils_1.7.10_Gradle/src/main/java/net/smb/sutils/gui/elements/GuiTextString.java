...
public class GuiTextString extends GuiElement {
	...
	public GuiTextString(int posX, int posY, float scale, String text){
...
//			}
			...
			if(hihighlighted) {
	            ...
	            this.func_152125_a(this.posX, this.posY, 0, 0, 1, 1, maxWidth, this.height, 1, 1);
			...
			for(int i = 0; i < lines.length; i++) {
	        	...
	        	//this.drawString(fontRender, lines[i],0, 0, 14737632);
...
//			}
	...
	public void UpdateLines() {
		...
		if(colorCodes) this.lines = Utils.convertAmpCodes(newText).split("(\\n)+");
