...
public class GuiButtonMenu extends GuiElement{
	...
	public void draw(Minecraft mc, int positionX, int positionY)
    {
        if (this.visible)
        {
            ...
            this.func_152125_a(this.posX+this.height/4, this.posY+this.height/4, 0, 0, 1, 1, (int)(this.height/2.5F*this.imgWidthScale), (int)(this.height/2*this.imgHeightScale), 1, 1);
