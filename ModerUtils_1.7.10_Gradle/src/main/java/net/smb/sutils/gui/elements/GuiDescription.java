...
public class GuiDescription extends GuiElement {
	...
	public void draw(Minecraft mc, int positionX, int positionY)
    {
        if (this.visible)
        {
            ...
            this.func_152125_a(tooltipPosX, tooltipPosY, 0, 0, 1, 1, tooltipWidth + this.width, tooltipMH/2, 1, 3);
            this.func_152125_a(tooltipPosX, tooltipPosY+tooltipHeight-(tooltipMH/2), 0, 2, 1, 1, tooltipWidth + this.width, tooltipMH/2, 1, 3);
            this.func_152125_a(tooltipPosX, tooltipPosY+this.tooltipMH/2, 0, 1, 1, 1, tooltipWidth + this.width, tooltipHeight-tooltipMH+1, 1, 3);
            
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 0.8F);
            mc.getTextureManager().bindTexture(GuiTheme.button);
            this.func_152125_a(tooltipPosX+30, tooltipPosY+25, 0, 0, 1, 1, this.width, exampleHeight, 1, 1);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
